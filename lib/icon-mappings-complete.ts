...
export interface CompleteIconMapping {
  lucide: React.ComponentType<{ className?: string; style?: React.CSSProperties }>
  'react-icons': React.ComponentType<{ className?: string; style?: React.CSSProperties }>
  tabler: React.ComponentType<{ className?: string; style?: React.CSSProperties }>
  heroicons: React.ComponentType<{ className?: string; style?: React.CSSProperties }>
  feather: React.ComponentType<{ className?: string; style?: React.CSSProperties }>
  phosphor: React.ComponentType<{ className?: string; style?: React.CSSProperties }>
  remix: React.ComponentType<{ className?: string; style?: React.CSSProperties }>
  bootstrap: React.ComponentType<{ className?: string; style?: React.CSSProperties }>
}
